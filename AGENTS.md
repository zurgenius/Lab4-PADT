Это проект 4ой лабораторной по информатике

Основные правила
- не использовать std::vector, не использовать умные укзаатели
- пользоваться только типами данных уже присутсвующими в папке
